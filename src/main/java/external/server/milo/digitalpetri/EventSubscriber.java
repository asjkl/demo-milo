...
public class EventSubscriber implements Runnable {
    ...
    private static Integer nodeId=2258;
    ...
    public EventSubscriber(OpcUaClient opcUaClient) throws UaException {
	...
	EventSubscriber subscriptionThread =new EventSubscriber(opcUaClient);
